...
import { SparklesPreview } from './_components/profile/spark_bg';
import { AnimatedTooltipPreview } from './_components/profile/avatar_circle';
      ...
      <section className=' z-10 flex flex-grow m-10 mt-16 absolute inset-0 flex-col justify-center items-center'>
        <div className="flex flex-grow m-14 max-h-96 w-full">
          <div className="flex-1 mr-4">
            <h1 className='text-white text-3xl p-1'>Portafolio de Proyectos</h1>
