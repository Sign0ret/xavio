...
export function HelpCircleIcon({ className, ...rest }: IconProps) {
  return (
    <svg
      {...rest}
      className={className}
...
export function MessageCircleIcon({ className, ...rest }: IconProps) {
  return (
    <svg
      {...rest}
      className={className}
...
export function PersonStandingIcon({ className, ...rest }: IconProps) {
  return (
    <svg
      {...rest}
      className={className}
...
export function FileQuestionIcon({ className, ...rest }: IconProps) {
  return (
    <svg
      {...rest}
      className={className}
...
export function ClipboardIcon({ className, ...rest }: IconProps) {
  return (
    <svg
      {...rest}
      className={className}
...
function ExternalLinkIcon({ className, ...rest }: IconProps) {
  return (
    <svg
      {...rest}
      className={className}
